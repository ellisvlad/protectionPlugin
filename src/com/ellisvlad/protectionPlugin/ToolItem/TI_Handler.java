...
public class TI_Handler {
	...
	public static ItemStack makeTool(Player p) {
		...
		Material mat=Material.getMaterial(pc.getTool_id());
		if (mat==null) mat=Material.getMaterial(pc.getTool_id());
		
		return Utils.makeItemStack(mat, 1, (short)pc.getTool_data(), Main.globalConfig.tool_name, Main.globalConfig.tool_description.split("\n"), true);
	}
